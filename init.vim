...
" Toggle Deoplete
noremap <leader>n :DeopleteToggle<CR>
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Ultisnips - Integration deoplete
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Custon TAB function to activate completion on Ultisnips + deoplete
...
" TAB  Ultisnips + Deoplete Integration
inoremap <TAB> <C-R>=g:UltiSnips_Complete()<cr>

let g:UltiSnipsExpandTrigger="<nop>" "Important for deoplete Integration
